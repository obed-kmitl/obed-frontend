...
import { EditOutlined, DeleteOutlined, SaveOutlined, CloseCircleTwoTone } from "@ant-design/icons";
...
export const ActivityTable = ({ subActivity, setTotalScore }) => {
  ...
  const EditableCell = ({
    ...
    switch (inputType) {
      case "clos":
        inputNode = (
          <Select mode="multiple" showSearch placeholder="Select CLOs" style={{ width: "350px" }}>
            {cloList.map((ele) => (
      ...
      case "max_score":
        ...
        break;
      case "detail":
        inputNode = <TextArea autoSize={{ minRows: 3, maxRows: 3 }} />;
        break;
      default:
        inputNode = <Input />;
        break;
        ...
        return editable ? (
          ...
          <>
            ...
            <Popconfirm
              ...
              onConfirm={() => deleteSubActivity(record.sub_activity_id)}
            >
              <Typography.Link disabled={editingKey !== "" || isNewAdded === true} type="danger">
                <DeleteOutlined />
              </Typography.Link>
            </Popconfirm>
          </>
  ...
  return (
    <div className={styles.activityTable}>
      <div className={styles.header}>
        ...
        <Button onClick={() => add()} disabled={editingKey !== "" || isNewAdded === true}>
          Add
        </Button>
      </div>
