...
export const MappingTable = ({ standard = [], standardNo, relativeStandard ,isEdit}) => {
                                ...
                                <TreeNode
                                    ...
                                    {option.subStandard.map((item) =>
                                        <TreeNode
                                            ...
                                            title={option.standardNo + "." + item.subStandardNo + " " + item.subStandardName}
                                        />
                                    )}
                                </TreeNode>
                            )}
    ...
    const columns = [
        ...
        },
        {
            ...
            editable: true,
            render: (mapping) => {
                return mapping.map((element)=><Tag style={{ height: '36px', lineHeight: '2.5', fontSize: '14px', margin:".25rem" }}>{element}</Tag>)
