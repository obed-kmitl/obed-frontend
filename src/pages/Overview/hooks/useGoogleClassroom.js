...
export const useGoogleClassroom = () => {
    ...
    function handleChangeGClass() {
        setggClassroomVisible(true);
        setLinkedGClass(allGClass.find(e=>e.id===selectedGClass)||linkedGClass);
        setChangeCard(true);
    }
    ...
    return [allGClass,selectedGClass,ggClassroomVisible, handleAddGClass,handleOk,handleCancel,handleCardClick,linkedGClass,handleChangeGClass,changeCard,handleDeleteGClass]
}
